    ...
    <HeaderContainer ref={headerRef}  style={{ backgroundColor: scrolled ? "rgba(0,0,0,0.85)" : "transparent" }}>
      ...
      <Nav ref={navRef}>
        ...
        <NavLink onClick={() => handleNavLinkClick('/services')} className={isActive('/services') ? 'active' : ''} style={{ '--animate-duration': '5s' }}>Solutions & Services</NavLink>
         <NavLink onClick={() => handleNavLinkClick('/newsroom')} className={isActive('/newsroom') ? 'active' : ''} style={{ '--animate-duration': '5s' }}>News Room / Media</NavLink>
      ...
      <MobileMenu isOpen={isMobileMenuOpen} ref={mobileMenuRef}>
        ...
        <NavLink onClick={() => handleNavLinkClick('/services')} className={isActive('/services') ? 'active' : ''}>Solutions & Services</NavLink>
         <NavLink onClick={() => handleNavLinkClick('/newsroom')} className={isActive('/newsroom') ? 'active' : ''}>News Room / Media</NavLink>
